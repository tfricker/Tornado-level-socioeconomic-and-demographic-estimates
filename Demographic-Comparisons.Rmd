...
df = df %>%
  ...
  dplyr::select(TotalPopSE, TotalPopCV, PopDSE, PopDCV, Black, BlackSE, BlackCV, MedianIncomeSE, MedianIncomeCV, MobileHomes, MobileHomesSE, MobileHomesCV)
...
out2010.sf$AreaPath = SPC.sf$AreaPth[c(2,1,20,18,5,15,4,3,8,12,7,19,10,13,14,9,11,6,17,16)]
