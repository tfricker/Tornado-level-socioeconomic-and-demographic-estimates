...
US2010.sf = US2010.sf %>%
  mutate(MaleUnder18 = MaleUnder5 + Male5.9 + Male10.14 + Male15.17,
         Male18to44 = Male18.19 + Male20 + Male21 + Male22.24 + Male25.29 + Male30.34 
         + Male35.39 + Male40.44,
         ...
         Female18to44 = Female18.19 + Female20 + Female21 + Female22.24 + Female25.29 
...
out <- aw_interpolate(Torn2016.sf, 
               ...
               source = US2010.sf, 
               sid = "ID2",
               extensive = c("TotalPop", "TotalMale", "MaleUnder18", "Male18to44",
                             "Male45to64", "MaleOver65", "TotalFemale", "FemaleUnder18",
                             "Female18to44", "Female45to64", "FemaleOver65", "White",
                             "Black", "TotalHousingUnits", "MobileHomes"),
