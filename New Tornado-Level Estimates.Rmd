...
st_transform(Torn.sf, crs = "+proj=longlat +datum=WGS84")
```

```{r}
TornL = as(Torn.sf, "Spatial")
TornL = spTransform(TornL, CRS("+init=epsg:2163"))
TornPo = gBuffer(TornL, byid = TRUE, width = TornL$Width/2, capStyle = "FLAT")
TornPo.sf <- st_as_sf(TornPo)
```
