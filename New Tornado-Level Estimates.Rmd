...
US2010.sf <- us2010 %>%
  mutate(ID2 = 1:nrow(us2010),
    geometry = Tracts_2010.sf$geometry[us2010$GISJOIN]) %>%
  st_as_sf()
...
US1990.sf <- us1990 %>%
  mutate(ID2 = 1:nrow(us1990),
    geometry = Tracts_1990.sf$geometry[us1990$GISJOIN]) %>%
  st_as_sf()
...
df1$MaleUnder18_2000[is.na(df1$MaleUnder18_2000)] = df1$MaleUnder18_1990[is.na(df$MaleUnder18_2000)]
df1$Male18to44_2000[is.na(df1$Male18to44_2000)] = df1$Male18to44_1990[is.na(df$Male18to44_2000)]
df1$Male45to64_2000[is.na(df1$Male45to64_2000)] = df1$Male45to64_1990[is.na(df$Male45to64_2000)]
df1$MaleOver65_2000[is.na(df1$MaleOver65_2000)] = df1$MaleOver65_1990[is.na(df$MaleOver65_2000)]

# Females
df1$TotalFemale_2000[is.na(df1$TotalFemale_2000)] = df1$TotalFemale_1990[is.na(df1$TotalFemale_2000)]
df1$FemaleUnder18_2000[is.na(df1$FemaleUnder18_2000)] = df1$FemaleUnder18_1990[is.na(df$FemaleUnder18_2000)]
df1$Female18to44_2000[is.na(df1$Female18to44_2000)] = df1$Female18to44_1990[is.na(df$Female18to44_2000)]
df1$Female45to64_2000[is.na(df1$Female45to64_2000)] = df1$Female45to64_1990[is.na(df$Female45to64_2000)]
df1$FemaleOver65_2000[is.na(df1$FemaleOver65_2000)] = df1$FemaleOver65_1990[is.na(df$FemaleOver65_2000)]

# White and Black
df1$White_2000[is.na(df1$White_2000)] = df1$White_1990[is.na(df$White_2000)]
df1$Black_2000[is.na(df1$Black_2000)] = df1$Black_1990[is.na(df$Black_2000)]

# Housing Units and Mobile Homes
df1$TotalHousingUnits_2000[is.na(df1$TotalHousingUnits_2000)] = df1$TotalHousingUnits_1990[is.na(df$TotalHousingUnits_2000)]
df1$MobileHomes_2000[is.na(df1$MobileHomes_2000)] = df1$MobileHomes_1990[is.na(df$MobileHomes_2000)]
...
df1$MaleUnder18_1990[is.na(df1$MaleUnder18_1990)] = df1$MaleUnder18_2000[is.na(df$MaleUnder18_1990)]
df1$Male18to44_1990[is.na(df1$Male18to44_1990)] = df1$Male18to44_2000[is.na(df$Male18to44_1990)]
df1$Male45to64_1990[is.na(df1$Male45to64_1990)] = df1$Male45to64_2000[is.na(df$Male45to64_1990)]
df1$MaleOver65_1990[is.na(df1$MaleOver65_1990)] = df1$MaleOver65_2000[is.na(df$MaleOver65_1990)]

# Females
df1$TotalFemale_1990[is.na(df1$TotalFemale_1990)] = df1$TotalFemale_2000[is.na(df1$TotalFemale_1990)]
df1$FemaleUnder18_1990[is.na(df1$FemaleUnder18_1990)] = df1$FemaleUnder18_2000[is.na(df$FemaleUnder18_1990)]
df1$Female18to44_1990[is.na(df1$Female18to44_1990)] = df1$Female18to44_2000[is.na(df$Female18to44_1990)]
df1$Female45to64_1990[is.na(df1$Female45to64_1990)] = df1$Female45to64_2000[is.na(df$Female45to64_1990)]
df1$FemaleOver65_1990[is.na(df1$FemaleOver65_1990)] = df1$FemaleOver65_2000[is.na(df$FemaleOver65_1990)]

# White and Black
df1$White_1990[is.na(df1$White_1990)] = df1$White_2000[is.na(df$White_1990)]
df1$Black_1990[is.na(df1$Black_1990)] = df1$Black_2000[is.na(df$Black_1990)]

# Housing Units and Mobile Homes
df1$TotalHousingUnits_1990[is.na(df1$TotalHousingUnits_1990)] = df1$TotalHousingUnits_2000[is.na(df$TotalHousingUnits_1990)]
df1$MobileHomes_1990[is.na(df1$MobileHomes_1990)] = df1$MobileHomes_2000[is.na(df$MobileHomes_1990)]
...
Run the same code for the 2000--2010 data.
```{r}
