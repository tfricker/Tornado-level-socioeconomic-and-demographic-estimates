...
```{r}
xxx = sfdf %>%
  filter(sfdf$om == 314625 | sfdf$om == 301943 | sfdf$om == 305917 | sfdf$om == 306606 | sfdf$om == 296616 | sfdf$om == 614437 | sfdf$om == 613862 |  sfdf$om == 606471 | sfdf$om == 552175 | sfdf$om == 574336 |  sfdf$om == 607146 | sfdf$om == 523250 | sfdf$om == 547725 | sfdf$om == 552705 | sfdf$om == 483896 | sfdf$om == 560160 | sfdf$om == 480993 | sfdf$om == 613718 | sfdf$om == 613878 | sfdf$om == 614436)

xxx = rename(xxx, "Name" = "om")
xxx$Name = c("Arab, AL", "Tuscaloosa-Birmingham, AL", "Cartersville, GA", "Griffin, GA", "Joplin, MO", "Westville, IL", "Brookport, IL",  "Salem, AL", "Blountstown, FL", "Columbia, MS", "Laurel, MS", "Tulsa, OK", "Rochelle, IL", "Garland-Rowlett, TX", "Dermott, AR", "Edison, GA", "Katie, OK", "Boswell, OK", "Rosalie, AL", "Lutts, TN")
xxx = xxx[,c(1,54)]
#xx = xx[c(2,5,9,15),]
#yy = TornDAT.sfdf[c(1,5,6,16),]
```
